...
public class LooseTypeCastTest {
  ...
  private static final TypeCast TYPE_CAST = TypeCast.create("loose", TASK);
  ...
  public void asBoolean() {
    ...
    assertThat(asBoolean.apply("string"), is(nullValue()));
    assertThat(asBoolean.apply("null"), is(nullValue()));
    ...
    assertThat(asBoolean.apply(-100.0), is(nullValue()));
    assertThat(asBoolean.apply(-10.00), is(nullValue()));
    assertThat(asBoolean.apply(-1.10), is(nullValue()));
    assertThat(asBoolean.apply(-0.10), is(nullValue()));
    assertThat(asBoolean.apply(-1.0), is(nullValue()));
    assertThat(asBoolean.apply(-0.0), is(false));
    assertThat(asBoolean.apply(-1), is(nullValue()));
    assertThat(asBoolean.apply(-0), is(false));
    assertThat(asBoolean.apply(0), is(false));
    assertThat(asBoolean.apply(1), is(true));
    assertThat(asBoolean.apply(0.0), is(false));
  ...
  public void asLong() {
    ...
    assertThat(asLong.apply("string"), is(nullValue()));
    assertThat(asLong.apply("null"), is(nullValue()));
    assertThat(asLong.apply(false), is(nullValue()));
    assertThat(asLong.apply(true), is(nullValue()));
    assertThat(asLong.apply("-100.0"), is(-100L));
    assertThat(asLong.apply("-10.00"), is(-10L));
    assertThat(asLong.apply("-1.10"), is(nullValue()));
    assertThat(asLong.apply("-0.10"), is(nullValue()));
    ...
    assertThat(asLong.apply(new BigDecimal("-1.10")), is(nullValue()));
    assertThat(asLong.apply(new BigDecimal("-0.10")), is(nullValue()));
  ...
  public void asDouble() {
    ...
    assertThat(asDouble.apply("string"), is(nullValue()));
    assertThat(asDouble.apply("null"), is(nullValue()));
    assertThat(asDouble.apply(false), is(nullValue()));
    assertThat(asDouble.apply(true), is(nullValue()));
  ...
  public void asTimestamp() {
    ...
    assertThat(asTimestamp__.apply("string"), is(nullValue()));
    assertThat(asTimestamp__.apply("null"), is(nullValue()));
    assertThat(asTimestamp__.apply(false), is(nullValue()));
    assertThat(asTimestamp__.apply(true), is(nullValue()));
  ...
  public void asJson() {
    ...
    assertThat(asJson.apply("string"), is(nullValue()));
