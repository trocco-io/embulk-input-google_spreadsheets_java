...
public class MinimalTypeCastTest {
  private static final PluginTask TASK = PluginTaskBuilder.getDefault().build();
  private static final TypeCast TYPE_CAST = TypeCast.create("minimal", TASK);
  ...
  public void asBoolean() {
    ...
    assertThat(asBoolean.apply("string"), is(true));
    assertThat(asBoolean.apply("null"), is(true));
    ...
    assertThat(asBoolean.apply(-100.0), is(true));
    assertThat(asBoolean.apply(-10.00), is(true));
    assertThat(asBoolean.apply(-1.10), is(true));
    assertThat(asBoolean.apply(-0.10), is(true));
  ...
  public void asLong() {
    ...
    assertTypeCastException(() -> asLong.apply(false), "Cannot type cast 'false' to number", NumberFormatException.class);
    assertTypeCastException(() -> asLong.apply(true), "Cannot type cast 'true' to number", NumberFormatException.class);
    // spotless:on
    assertThat(asLong.apply("-100.0"), is(-100L));
    assertThat(asLong.apply("-10.00"), is(-10L));
    assertThat(asLong.apply("-1.10"), is(-1L));
    assertThat(asLong.apply("-0.10"), is(0L));
    ...
    assertThat(asLong.apply(new BigDecimal("-1.10")), is(-1L));
    assertThat(asLong.apply(new BigDecimal("-0.10")), is(0L));
  ...
  public void asDouble() {
    ...
    assertTypeCastException(() -> asDouble.apply(false), "Cannot type cast 'false' to number", NumberFormatException.class);
    assertTypeCastException(() -> asDouble.apply(true), "Cannot type cast 'true' to number", NumberFormatException.class);
    // spotless:on
  ...
  public void asTimestamp() {
    ...
    assertTypeCastException(() -> asTimestamp__.apply(false), "Cannot type cast 'false' to instant", RubyDateTimeParseException.class);
    assertTypeCastException(() -> asTimestamp__.apply(true), "Cannot type cast 'true' to instant", RubyDateTimeParseException.class);
